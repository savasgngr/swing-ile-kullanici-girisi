...
public class Kullanicigirisi extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(kullanici, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(parola, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(149, 149, 149)
                        .addComponent(giris)))
    ...
    private void girisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_girisActionPerformed
        String kullniciAdi= kullanici.getText();
        String parola=new String(this.parola.getPassword());
        String mesaj;
        if (kullniciAdi.equals("savas")&&parola.equals("12345")) {
            
            mesaj="hoşgeldiniz "+kullniciAdi;
        }else if (!kullniciAdi.equals("savas")&&parola.equals("12345")) {
          mesaj="kullanıcı adı hatalı";
        }else if (kullniciAdi.equals("savas")&&!parola.equals("12345")) {
          mesaj="şifreniz hatalı";
        }else{
          mesaj="kullanıcı adınız ve şifreniz hatalı";
        }
